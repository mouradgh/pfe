...
public class DataModel {
    ...
    public static String tableHeader = "File name, File size, Download speed, Upload speed, Date, Time, Connection type, Latitude, Longitude";
    ...
    @Override
    public String toString() {
        return fileName + "," + fileSize + "," + downloadSpeed + "," + uploadSpeed + "," + date + "," + time + "," + internetType + "," + latLng.latitude + "," + latLng.longitude;
    }
